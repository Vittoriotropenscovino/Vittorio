...
## 📦 Creare un APK Installabile

Vuoi installare l'app direttamente sul telefono senza Expo Go?
...
Dopo 15-20 minuti riceverai un link per scaricare l'APK!

📖 **Guide complete:**
- `APK_BUILD_GUIDE.md` - Guida dettagliata con tutti i metodi
- `BUILD_COMMANDS.md` - Comandi rapidi per build
